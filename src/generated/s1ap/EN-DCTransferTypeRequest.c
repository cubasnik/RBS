...
asn_TYPE_member_t asn_MBR_EN_DCTransferTypeRequest_1[] = {
	{ ATF_POINTER, 0, offsetof(struct EN_DCTransferTypeRequest, sourceeNB),
	...
	{ ATF_POINTER, 0, offsetof(struct EN_DCTransferTypeRequest, targetengNB),
	...
	{ ATF_POINTER, 1, offsetof(struct EN_DCTransferTypeRequest, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P55,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
