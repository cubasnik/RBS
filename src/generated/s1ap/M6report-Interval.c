...
static int asn_validate_M6report_Interval_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_M6report_Interval value = *(e_M6report_Interval*)sptr;
    switch(value) {
    case M6report_Interval_ms1024:
    case M6report_Interval_ms2048:
    case M6report_Interval_ms5120:
    case M6report_Interval_ms10240:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_M6report_Interval = {
	...
	sizeof(asn_DEF_M6report_Interval_tags_1)
		/sizeof(asn_DEF_M6report_Interval_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_M6report_Interval_constr_1, .general_constraints = asn_validate_M6report_Interval_1 },
