...
static int asn_validate_Criticality_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Criticality value = *(e_Criticality*)sptr;
    switch(value) {
...
asn_TYPE_descriptor_t asn_DEF_Criticality = {
	...
	sizeof(asn_DEF_Criticality_tags_1)
		/sizeof(asn_DEF_Criticality_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_Criticality_constr_1, .general_constraints = asn_validate_Criticality_1 },
