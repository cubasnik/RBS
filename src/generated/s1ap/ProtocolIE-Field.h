...
typedef enum PathSwitchRequestAcknowledgeIEs__value_PR {
	...
	PathSwitchRequestAcknowledgeIEs__value_PR_HandoverRestrictionList
...
struct EN_DCSONConfigurationTransfer;

/* Forward definitions */
typedef struct E_RABToBeSetupItemBearerSUReqIEs__value {
...
typedef struct E_RABSetupItemBearerSUResIEs__value {
...
typedef struct E_RABToBeModifiedItemBearerModReqIEs__value {
...
typedef struct E_RABModifyItemBearerModResIEs__value {
...
typedef struct E_RABReleaseItemBearerRelCompIEs__value {
...
typedef struct E_RABToBeSetupItemCtxtSUReqIEs__value {
...
typedef struct E_RABSetupItemCtxtSUResIEs__value {
...
typedef struct TAIItemIEs__value {
...
typedef struct UE_associatedLogicalS1_ConnectionItemRes__value {
...
typedef struct UE_associatedLogicalS1_ConnectionItemResAck__value {
...
typedef struct E_RABModifyItemBearerModConfIEs__value {
...
typedef struct Bearers_SubjectToStatusTransfer_ItemIEs__value {
...
typedef struct E_RABInformationListIEs__value {
...
typedef struct E_RABItemIEs__value {
...
typedef struct E_RABUsageReportItemIEs__value {
...
typedef struct MDTMode_ExtensionIE__value {
...
typedef struct RecommendedCellItemIEs__value {
...
typedef struct RecommendedENBItemIEs__value {
...
typedef struct SecondaryRATDataUsageReportItemIEs__value {
...
typedef struct SONInformation_ExtensionIE__value {
...
typedef struct HandoverRequiredIEs__value {
...
typedef struct HandoverCommandIEs__value {
...
typedef struct HandoverPreparationFailureIEs__value {
...
typedef struct HandoverRequestIEs__value {
...
typedef struct HandoverRequestAcknowledgeIEs__value {
...
typedef struct HandoverFailureIEs__value {
...
typedef struct HandoverNotifyIEs__value {
...
typedef struct PathSwitchRequestIEs__value {
...
typedef struct PathSwitchRequestAcknowledgeIEs__value {
...
typedef struct PathSwitchRequestFailureIEs__value {
...
typedef struct HandoverCancelIEs__value {
...
typedef struct HandoverCancelAcknowledgeIEs__value {
...
typedef struct E_RABSetupRequestIEs__value {
...
typedef struct E_RABSetupResponseIEs__value {
...
typedef struct E_RABModifyRequestIEs__value {
...
typedef struct E_RABModifyResponseIEs__value {
...
typedef struct E_RABReleaseCommandIEs__value {
...
typedef struct E_RABReleaseResponseIEs__value {
...
typedef struct E_RABReleaseIndicationIEs__value {
...
typedef struct InitialContextSetupRequestIEs__value {
...
typedef struct InitialContextSetupResponseIEs__value {
...
typedef struct InitialContextSetupFailureIEs__value {
...
typedef struct PagingIEs__value {
	...
	union PagingIEs__value_u {
		...
		struct AssistanceDataForPaging	*AssistanceDataForPaging;
...
typedef struct UEContextReleaseRequest_IEs__value {
...
typedef struct UEContextReleaseCommand_IEs__value {
...
typedef struct UEContextReleaseComplete_IEs__value {
...
typedef struct UEContextModificationRequestIEs__value {
...
typedef struct UEContextModificationResponseIEs__value {
...
typedef struct UEContextModificationFailureIEs__value {
...
typedef struct UERadioCapabilityMatchRequestIEs__value {
...
typedef struct UERadioCapabilityMatchResponseIEs__value {
...
typedef struct DownlinkNASTransport_IEs__value {
...
typedef struct InitialUEMessage_IEs__value {
...
typedef struct UplinkNASTransport_IEs__value {
...
typedef struct NASNonDeliveryIndication_IEs__value {
...
typedef struct RerouteNASRequest_IEs__value {
...
typedef struct NASDeliveryIndicationIEs__value {
...
typedef struct ResetIEs__value {
...
typedef struct ResetAcknowledgeIEs__value {
...
typedef struct ErrorIndicationIEs__value {
...
typedef struct S1SetupRequestIEs__value {
...
typedef struct S1SetupResponseIEs__value {
...
typedef struct S1SetupFailureIEs__value {
...
typedef struct ENBConfigurationUpdateIEs__value {
...
typedef struct ENBConfigurationUpdateAcknowledgeIEs__value {
...
typedef struct ENBConfigurationUpdateFailureIEs__value {
...
typedef struct MMEConfigurationUpdateIEs__value {
...
typedef struct MMEConfigurationUpdateAcknowledgeIEs__value {
...
typedef struct MMEConfigurationUpdateFailureIEs__value {
...
typedef struct DownlinkS1cdma2000tunnellingIEs__value {
...
typedef struct UplinkS1cdma2000tunnellingIEs__value {
...
typedef struct UECapabilityInfoIndicationIEs__value {
...
typedef struct ENBStatusTransferIEs__value {
...
typedef struct MMEStatusTransferIEs__value {
...
typedef struct TraceFailureIndicationIEs__value {
...
typedef struct CellTrafficTraceIEs__value {
...
typedef struct LocationReportingControlIEs__value {
...
typedef struct LocationReportingFailureIndicationIEs__value {
...
typedef struct LocationReportIEs__value {
...
typedef struct OverloadStartIEs__value {
...
typedef struct OverloadStopIEs__value {
...
typedef struct WriteReplaceWarningRequestIEs__value {
...
typedef struct WriteReplaceWarningResponseIEs__value {
...
typedef struct ENBDirectInformationTransferIEs__value {
...
typedef struct MMEDirectInformationTransferIEs__value {
...
typedef struct ENBConfigurationTransferIEs__value {
	ENBConfigurationTransferIEs__value_PR present;
	union ENBConfigurationTransferIEs__value_u {
		struct SONConfigurationTransfer	*SONConfigurationTransfer;
		struct EN_DCSONConfigurationTransfer	*EN_DCSONConfigurationTransfer;
	} choice;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} ENBConfigurationTransferIEs__value;
typedef struct MMEConfigurationTransferIEs__value {
...
typedef struct KillRequestIEs__value {
...
typedef struct KillResponseIEs__value {
...
typedef struct PWSRestartIndicationIEs__value {
...
typedef struct PWSFailureIndicationIEs__value {
...
typedef struct DownlinkUEAssociatedLPPaTransport_IEs__value {
...
typedef struct UplinkUEAssociatedLPPaTransport_IEs__value {
...
typedef struct DownlinkNonUEAssociatedLPPaTransport_IEs__value {
...
typedef struct UplinkNonUEAssociatedLPPaTransport_IEs__value {
...
typedef struct E_RABModificationIndicationIEs__value {
...
typedef struct E_RABModificationConfirmIEs__value {
...
typedef struct UEContextModificationIndicationIEs__value {
...
typedef struct UEContextModificationConfirmIEs__value {
...
typedef struct UEContextSuspendRequestIEs__value {
...
typedef struct UEContextSuspendResponseIEs__value {
...
typedef struct UEContextResumeRequestIEs__value {
...
typedef struct UEContextResumeResponseIEs__value {
...
typedef struct UEContextResumeFailureIEs__value {
...
typedef struct ConnectionEstablishmentIndicationIEs__value {
...
typedef struct RetrieveUEInformationIEs__value {
...
typedef struct UEInformationTransferIEs__value {
...
typedef struct ENBCPRelocationIndicationIEs__value {
...
typedef struct MMECPRelocationIndicationIEs__value {
...
typedef struct SecondaryRATDataUsageReportIEs__value {
...
typedef struct E_RABDataForwardingItemIEs__value {
...
typedef struct E_RABToBeSetupItemHOReqIEs__value {
...
typedef struct E_RABAdmittedItemIEs__value {
...
typedef struct E_RABFailedtoSetupItemHOReqAckIEs__value {
...
typedef struct E_RABToBeSwitchedDLItemIEs__value {
...
typedef struct E_RABToBeSwitchedULItemIEs__value {
...
typedef struct E_RABToBeModifiedItemBearerModIndIEs__value {
...
typedef struct E_RABNotToBeModifiedItemBearerModIndIEs__value {
...
typedef struct E_RABFailedToResumeItemResumeReqIEs__value {
...
typedef struct E_RABFailedToResumeItemResumeResIEs__value {
