...
/*
 * This type is implemented using E_RAB_IE_ContainerList_448P6,
...
asn_TYPE_descriptor_t asn_DEF_E_RABToBeModifiedListBearerModInd = {
	...
	sizeof(asn_DEF_E_RABToBeModifiedListBearerModInd_tags_1)
		/sizeof(asn_DEF_E_RABToBeModifiedListBearerModInd_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_E_RABToBeModifiedListBearerModInd_constr_1, .general_constraints = E_RABToBeModifiedListBearerModInd_constraint },
