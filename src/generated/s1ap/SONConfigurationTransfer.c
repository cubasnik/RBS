...
asn_TYPE_member_t asn_MBR_SONConfigurationTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct SONConfigurationTransfer, targeteNB_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct SONConfigurationTransfer, sourceeNB_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct SONConfigurationTransfer, sONInformation),
	...
	{ ATF_POINTER, 1, offsetof(struct SONConfigurationTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P106,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
