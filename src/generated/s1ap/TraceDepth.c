...
static int asn_validate_TraceDepth_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_TraceDepth value = *(e_TraceDepth*)sptr;
    switch(value) {
    case TraceDepth_minimum:
    case TraceDepth_medium:
    case TraceDepth_maximum:
    case TraceDepth_minimumWithoutVendorSpecificExtension:
    case TraceDepth_mediumWithoutVendorSpecificExtension:
    case TraceDepth_maximumWithoutVendorSpecificExtension:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_TraceDepth = {
	...
	sizeof(asn_DEF_TraceDepth_tags_1)
		/sizeof(asn_DEF_TraceDepth_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_TraceDepth_constr_1, .general_constraints = asn_validate_TraceDepth_1 },
