...
static int asn_validate_ReportAmountMDT_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ReportAmountMDT value = *(e_ReportAmountMDT*)sptr;
    switch(value) {
    case ReportAmountMDT_r1:
    case ReportAmountMDT_r2:
    case ReportAmountMDT_r4:
    case ReportAmountMDT_r8:
    case ReportAmountMDT_r16:
    case ReportAmountMDT_r32:
    case ReportAmountMDT_r64:
    case ReportAmountMDT_rinfinity:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ReportAmountMDT = {
	...
	sizeof(asn_DEF_ReportAmountMDT_tags_1)
		/sizeof(asn_DEF_ReportAmountMDT_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ReportAmountMDT_constr_1, .general_constraints = asn_validate_ReportAmountMDT_1 },
