...
extern asn_TYPE_descriptor_t asn_DEF_bt_rssi __attribute__((weak, alias("asn_DEF_bt_rssi_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_bt_rssi_4;
static asn_TYPE_descriptor_t asn_DEF_bt_rssi;
__attribute__((constructor)) static void asn_DEF_bt_rssi_4_alias_init(void) {
	asn_DEF_bt_rssi = asn_DEF_bt_rssi_4;
}
#endif
...
static int asn_validate_bt_rssi_4(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_BluetoothMeasurementConfiguration__bt_rssi value = *(e_BluetoothMeasurementConfiguration__bt_rssi*)sptr;
    switch(value) {
    case BluetoothMeasurementConfiguration__bt_rssi_true:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_BluetoothMeasurementConfiguration_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct BluetoothMeasurementConfiguration, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P26,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
