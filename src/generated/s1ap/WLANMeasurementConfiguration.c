...
extern asn_TYPE_descriptor_t asn_DEF_wlan_rssi __attribute__((weak, alias("asn_DEF_wlan_rssi_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_wlan_rssi_4;
static asn_TYPE_descriptor_t asn_DEF_wlan_rssi;
__attribute__((constructor)) static void asn_DEF_wlan_rssi_4_alias_init(void) {
	asn_DEF_wlan_rssi = asn_DEF_wlan_rssi_4;
}
#endif
...
#ifndef ASN1C_NO_UNSUFFIXED_PDU_ALIAS
#if defined(__ELF__) && (defined(__GNUC__) || defined(__clang__))
extern asn_TYPE_descriptor_t asn_DEF_wlan_rtt __attribute__((weak, alias("asn_DEF_wlan_rtt_7")));
#else
static asn_TYPE_descriptor_t asn_DEF_wlan_rtt_7;
static asn_TYPE_descriptor_t asn_DEF_wlan_rtt;
__attribute__((constructor)) static void asn_DEF_wlan_rtt_7_alias_init(void) {
	asn_DEF_wlan_rtt = asn_DEF_wlan_rtt_7;
}
#endif
#endif /* ASN1C_NO_UNSUFFIXED_PDU_ALIAS */
/*
...
static int asn_validate_wlan_rssi_4(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_WLANMeasurementConfiguration__wlan_rssi value = *(e_WLANMeasurementConfiguration__wlan_rssi*)sptr;
    switch(value) {
    case WLANMeasurementConfiguration__wlan_rssi_true:
        return 0;
    }
    return -1;
}
...
static int asn_validate_wlan_rtt_7(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_WLANMeasurementConfiguration__wlan_rtt value = *(e_WLANMeasurementConfiguration__wlan_rtt*)sptr;
    switch(value) {
    case WLANMeasurementConfiguration__wlan_rtt_true:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_WLANMeasurementConfiguration_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct WLANMeasurementConfiguration, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P143,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
