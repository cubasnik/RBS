...
asn_TYPE_member_t asn_MBR_SourceeNB_ID_1[] = {
	{ ATF_POINTER, 0, offsetof(struct SourceeNB_ID, global_ENB_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct SourceeNB_ID, selected_TAI),
	...
	{ ATF_POINTER, 1, offsetof(struct SourceeNB_ID, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P108,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
