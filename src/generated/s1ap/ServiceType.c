...
static int asn_validate_ServiceType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ServiceType value = *(e_ServiceType*)sptr;
    switch(value) {
    case ServiceType_qMC_for_streaming_service:
    case ServiceType_qMC_for_MTSI_service:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ServiceType = {
	...
	sizeof(asn_DEF_ServiceType_tags_1)
		/sizeof(asn_DEF_ServiceType_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ServiceType_constr_1, .general_constraints = asn_validate_ServiceType_1 },
