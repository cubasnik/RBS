...
static int asn_validate_MDT_Activation_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_MDT_Activation value = *(e_MDT_Activation*)sptr;
    switch(value) {
    case MDT_Activation_immediate_MDT_only:
    case MDT_Activation_immediate_MDT_and_Trace:
    case MDT_Activation_logged_MDT_only:
    case MDT_Activation_logged_MBSFN_MDT:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_MDT_Activation = {
	...
	sizeof(asn_DEF_MDT_Activation_tags_1)
		/sizeof(asn_DEF_MDT_Activation_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_MDT_Activation_constr_1, .general_constraints = asn_validate_MDT_Activation_1 },
