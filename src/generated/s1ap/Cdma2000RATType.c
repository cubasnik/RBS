...
static int asn_validate_Cdma2000RATType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Cdma2000RATType value = *(e_Cdma2000RATType*)sptr;
    switch(value) {
    case Cdma2000RATType_hRPD:
    case Cdma2000RATType_onexRTT:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_Cdma2000RATType = {
	...
	sizeof(asn_DEF_Cdma2000RATType_tags_1)
		/sizeof(asn_DEF_Cdma2000RATType_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_Cdma2000RATType_constr_1, .general_constraints = asn_validate_Cdma2000RATType_1 },
