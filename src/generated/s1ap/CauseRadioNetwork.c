...
static int asn_validate_CauseRadioNetwork_1(const asn_TYPE_descriptor_t *td,
    ...
    case CauseRadioNetwork_release_due_to_eutran_generated_reason:
    case CauseRadioNetwork_handover_cancelled:
    case CauseRadioNetwork_partial_handover:
    case CauseRadioNetwork_ho_failure_in_target_EPC_eNB_or_target_system:
    case CauseRadioNetwork_ho_target_not_allowed:
    case CauseRadioNetwork_tS1relocoverall_expiry:
    case CauseRadioNetwork_tS1relocprep_expiry:
    ...
    case CauseRadioNetwork_unknown_mme_ue_s1ap_id:
    case CauseRadioNetwork_unknown_enb_ue_s1ap_id:
    case CauseRadioNetwork_unknown_pair_ue_s1ap_id:
    ...
    case CauseRadioNetwork_cs_fallback_triggered:
    case CauseRadioNetwork_ue_not_available_for_ps_service:
    ...
    case CauseRadioNetwork_interrat_redirection:
    case CauseRadioNetwork_interaction_with_other_procedure:
    case CauseRadioNetwork_unknown_E_RAB_ID:
    ...
    case CauseRadioNetwork_s1_intra_system_handover_triggered:
    case CauseRadioNetwork_s1_inter_system_handover_triggered:
    case CauseRadioNetwork_x2_handover_triggered:
    case CauseRadioNetwork_redirection_towards_1xRTT:
    case CauseRadioNetwork_not_supported_QCI_value:
    case CauseRadioNetwork_invalid_CSG_Id:
    case CauseRadioNetwork_release_due_to_pre_emption:
    case CauseRadioNetwork_n26_interface_not_available:
        return 0;
    }
    return -1;
}
