...
asn_TYPE_member_t asn_MBR_LastVisitedEUTRANCellInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct LastVisitedEUTRANCellInformation, global_Cell_ID),
	...
	{ ATF_POINTER, 0, offsetof(struct LastVisitedEUTRANCellInformation, cellType),
	...
	{ ATF_POINTER, 1, offsetof(struct LastVisitedEUTRANCellInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P75,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
