...
/*
 * This type is implemented using E_RAB_IE_ContainerList_448P4,
...
asn_TYPE_descriptor_t asn_DEF_E_RABToBeSwitchedDLList = {
	...
	sizeof(asn_DEF_E_RABToBeSwitchedDLList_tags_1)
		/sizeof(asn_DEF_E_RABToBeSwitchedDLList_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_E_RABToBeSwitchedDLList_constr_1, .general_constraints = E_RABToBeSwitchedDLList_constraint },
