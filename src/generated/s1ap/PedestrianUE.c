...
static int asn_validate_PedestrianUE_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PedestrianUE value = *(e_PedestrianUE*)sptr;
    switch(value) {
    case PedestrianUE_authorized:
    case PedestrianUE_not_authorized:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_PedestrianUE = {
	...
	sizeof(asn_DEF_PedestrianUE_tags_1)
		/sizeof(asn_DEF_PedestrianUE_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_PedestrianUE_constr_1, .general_constraints = asn_validate_PedestrianUE_1 },
