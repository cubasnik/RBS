...
static int asn_validate_NRrestrictioninEPSasSecondaryRAT_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_NRrestrictioninEPSasSecondaryRAT value = *(e_NRrestrictioninEPSasSecondaryRAT*)sptr;
    switch(value) {
    case NRrestrictioninEPSasSecondaryRAT_nRrestrictedinEPSasSecondaryRAT:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_NRrestrictioninEPSasSecondaryRAT = {
	...
	sizeof(asn_DEF_NRrestrictioninEPSasSecondaryRAT_tags_1)
		/sizeof(asn_DEF_NRrestrictioninEPSasSecondaryRAT_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_NRrestrictioninEPSasSecondaryRAT_constr_1, .general_constraints = asn_validate_NRrestrictioninEPSasSecondaryRAT_1 },
