...
asn_TYPE_member_t asn_MBR_ScheduledCommunicationTime_1[] = {
	{ ATF_POINTER, 4, offsetof(struct ScheduledCommunicationTime, dayofWeek),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ .per_constraints = &asn_PER_memb_dayofWeek_constr_2, .general_constraints = memb_dayofWeek_constraint_1 },
	...
	{ ATF_POINTER, 3, offsetof(struct ScheduledCommunicationTime, timeofDayStart),
		...
		0,
		{ .per_constraints = &asn_PER_memb_timeofDayStart_constr_3, .general_constraints = memb_timeofDayStart_constraint_1 },
		0, 0, /* No default value */
		"timeofDayStart"
		},
	{ ATF_POINTER, 2, offsetof(struct ScheduledCommunicationTime, timeofDayEnd),
		...
		&asn_DEF_NativeInteger,
		0,
		{ .per_constraints = &asn_PER_memb_timeofDayEnd_constr_4, .general_constraints = memb_timeofDayEnd_constraint_1 },
		0, 0, /* No default value */
		"timeofDayEnd"
		},
	{ ATF_POINTER, 1, offsetof(struct ScheduledCommunicationTime, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P112,
		0,
		{
