...
asn_TYPE_member_t asn_MBR_UserLocationInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct UserLocationInformation, eutran_cgi),
	...
	{ ATF_POINTER, 0, offsetof(struct UserLocationInformation, tai),
	...
	{ ATF_POINTER, 1, offsetof(struct UserLocationInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P141,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
