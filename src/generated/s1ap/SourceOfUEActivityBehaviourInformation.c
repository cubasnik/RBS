...
static int asn_validate_SourceOfUEActivityBehaviourInformation_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SourceOfUEActivityBehaviourInformation value = *(e_SourceOfUEActivityBehaviourInformation*)sptr;
    switch(value) {
    case SourceOfUEActivityBehaviourInformation_subscription_information:
    case SourceOfUEActivityBehaviourInformation_statistics:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_SourceOfUEActivityBehaviourInformation = {
	...
	sizeof(asn_DEF_SourceOfUEActivityBehaviourInformation_tags_1)
		/sizeof(asn_DEF_SourceOfUEActivityBehaviourInformation_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_SourceOfUEActivityBehaviourInformation_constr_1, .general_constraints = asn_validate_SourceOfUEActivityBehaviourInformation_1 },
