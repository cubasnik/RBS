...
static int asn_validate_DL_Forwarding_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_DL_Forwarding value = *(e_DL_Forwarding*)sptr;
    switch(value) {
    case DL_Forwarding_dL_Forwarding_proposed:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_DL_Forwarding = {
	...
	sizeof(asn_DEF_DL_Forwarding_tags_1)
		/sizeof(asn_DEF_DL_Forwarding_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_DL_Forwarding_constr_1, .general_constraints = asn_validate_DL_Forwarding_1 },
