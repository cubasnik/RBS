...
static int asn_validate_EventType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_EventType value = *(e_EventType*)sptr;
    switch(value) {
    case EventType_direct:
    case EventType_change_of_serve_cell:
    case EventType_stop_change_of_serve_cell:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_EventType = {
	...
	sizeof(asn_DEF_EventType_tags_1)
		/sizeof(asn_DEF_EventType_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_EventType_constr_1, .general_constraints = asn_validate_EventType_1 },
