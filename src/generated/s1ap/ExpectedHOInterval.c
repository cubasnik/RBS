...
static int asn_validate_ExpectedHOInterval_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ExpectedHOInterval value = *(e_ExpectedHOInterval*)sptr;
    switch(value) {
    case ExpectedHOInterval_sec15:
    case ExpectedHOInterval_sec30:
    case ExpectedHOInterval_sec60:
    case ExpectedHOInterval_sec90:
    case ExpectedHOInterval_sec120:
    case ExpectedHOInterval_sec180:
    case ExpectedHOInterval_long_time:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ExpectedHOInterval = {
	...
	sizeof(asn_DEF_ExpectedHOInterval_tags_1)
		/sizeof(asn_DEF_ExpectedHOInterval_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ExpectedHOInterval_constr_1, .general_constraints = asn_validate_ExpectedHOInterval_1 },
