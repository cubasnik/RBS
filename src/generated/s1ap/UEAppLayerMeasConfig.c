...
asn_TYPE_member_t asn_MBR_UEAppLayerMeasConfig_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UEAppLayerMeasConfig, containerForAppLayerMeasConfig),
		...
		0,
		{ .per_constraints = &asn_PER_memb_containerForAppLayerMeasConfig_constr_2, .general_constraints = memb_containerForAppLayerMeasConfig_constraint_1 },
		0, 0, /* No default value */
		"containerForAppLayerMeasConfig"
		},
	{ ATF_POINTER, 0, offsetof(struct UEAppLayerMeasConfig, areaScopeOfQMC),
	...
	{ ATF_POINTER, 1, offsetof(struct UEAppLayerMeasConfig, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P135,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
