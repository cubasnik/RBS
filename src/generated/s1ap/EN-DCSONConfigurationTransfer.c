...
asn_TYPE_member_t asn_MBR_EN_DCSONConfigurationTransfer_1[] = {
	{ ATF_POINTER, 0, offsetof(struct EN_DCSONConfigurationTransfer, transfertype),
	...
	{ ATF_POINTER, 0, offsetof(struct EN_DCSONConfigurationTransfer, sONInformation),
	...
	{ ATF_POINTER, 1, offsetof(struct EN_DCSONConfigurationTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_165P54,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
