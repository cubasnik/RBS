...
static int asn_validate_LoggingDuration_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_LoggingDuration value = *(e_LoggingDuration*)sptr;
    switch(value) {
    case LoggingDuration_m10:
    case LoggingDuration_m20:
    case LoggingDuration_m40:
    case LoggingDuration_m60:
    case LoggingDuration_m90:
    case LoggingDuration_m120:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_LoggingDuration = {
	...
	sizeof(asn_DEF_LoggingDuration_tags_1)
		/sizeof(asn_DEF_LoggingDuration_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_LoggingDuration_constr_1, .general_constraints = asn_validate_LoggingDuration_1 },
