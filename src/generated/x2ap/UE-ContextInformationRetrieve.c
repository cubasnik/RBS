...
asn_TYPE_member_t asn_MBR_UE_ContextInformationRetrieve_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct UE_ContextInformationRetrieve, uESecurityCapabilities),
	...
	{ ATF_POINTER, 0, offsetof(struct UE_ContextInformationRetrieve, aS_SecurityInformation),
	...
	{ ATF_POINTER, 0, offsetof(struct UE_ContextInformationRetrieve, uEaggregateMaximumBitRate),
	...
	{ ATF_POINTER, 0, offsetof(struct UE_ContextInformationRetrieve, e_RABs_ToBeSetup_ListRetrieve),
	...
	{ ATF_POINTER, 1, offsetof(struct UE_ContextInformationRetrieve, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P167,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_UE_ContextInformationRetrieve_specs_1 = {
