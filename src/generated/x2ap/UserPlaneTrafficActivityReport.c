...
static int asn_validate_UserPlaneTrafficActivityReport_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_UserPlaneTrafficActivityReport value = *(e_UserPlaneTrafficActivityReport*)sptr;
    switch(value) {
    case UserPlaneTrafficActivityReport_inactive:
    case UserPlaneTrafficActivityReport_re_activated:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_UserPlaneTrafficActivityReport = {
	...
	sizeof(asn_DEF_UserPlaneTrafficActivityReport_tags_1)
		/sizeof(asn_DEF_UserPlaneTrafficActivityReport_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_UserPlaneTrafficActivityReport_constr_1, .general_constraints = asn_validate_UserPlaneTrafficActivityReport_1 },
