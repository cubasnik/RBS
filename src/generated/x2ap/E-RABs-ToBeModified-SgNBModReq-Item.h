...
struct ProtocolExtensionContainer_162P181;
...
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABs_ToBeModified_SgNBModReq_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_E_RABs_ToBeModified_SgNBModReq_Item_1[4];
