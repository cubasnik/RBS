...
static int asn_validate_RRCConnReestabIndicator_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RRCConnReestabIndicator value = *(e_RRCConnReestabIndicator*)sptr;
    switch(value) {
    case RRCConnReestabIndicator_reconfigurationFailure:
    case RRCConnReestabIndicator_handoverFailure:
    case RRCConnReestabIndicator_otherFailure:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_RRCConnReestabIndicator = {
	...
	sizeof(asn_DEF_RRCConnReestabIndicator_tags_1)
		/sizeof(asn_DEF_RRCConnReestabIndicator_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_RRCConnReestabIndicator_constr_1, .general_constraints = asn_validate_RRCConnReestabIndicator_1 },
