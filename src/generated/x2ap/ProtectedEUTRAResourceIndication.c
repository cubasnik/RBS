...
asn_TYPE_member_t asn_MBR_ProtectedEUTRAResourceIndication_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ProtectedEUTRAResourceIndication, protectedResourceList),
	...
	{ ATF_POINTER, 3, offsetof(struct ProtectedEUTRAResourceIndication, mBSFNControlRegionLength),
		...
		&asn_DEF_NativeInteger,
		0,
		{ .per_constraints = &asn_PER_memb_mBSFNControlRegionLength_constr_4, .general_constraints = memb_mBSFNControlRegionLength_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct ProtectedEUTRAResourceIndication, pDCCHRegionLength),
		...
		&asn_DEF_NativeInteger,
		0,
		{ .per_constraints = &asn_PER_memb_pDCCHRegionLength_constr_5, .general_constraints = memb_pDCCHRegionLength_constraint_1 },
		0, 0, /* No default value */
		"pDCCHRegionLength"
		},
	{ ATF_POINTER, 1, offsetof(struct ProtectedEUTRAResourceIndication, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P81,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
