...
asn_TYPE_member_t asn_MBR_UE_ContextReferenceAtWT_1[] = {
	{ ATF_POINTER, 0, offsetof(struct UE_ContextReferenceAtWT, wTID),
	...
	{ ATF_POINTER, 1, offsetof(struct UE_ContextReferenceAtWT, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P128,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_UE_ContextReferenceAtWT_specs_1 = {
