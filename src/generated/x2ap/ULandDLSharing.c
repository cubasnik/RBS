...
asn_TYPE_member_t asn_MBR_ULandDLSharing_1[] = {
	{ ATF_POINTER, 0, offsetof(struct ULandDLSharing, uLResourcesULandDLSharing),
	...
	{ ATF_POINTER, 0, offsetof(struct ULandDLSharing, dLResourcesULandDLSharing),
	...
	{ ATF_POINTER, 1, offsetof(struct ULandDLSharing, iE_Extensions),
		...
		&asn_DEF_ProtocolExtensionContainer_162P116,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
