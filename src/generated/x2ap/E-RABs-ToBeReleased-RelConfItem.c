...
asn_per_constraints_t asn_PER_type_E_RABs_ToBeReleased_RelConfItem_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  1,  1,  0,  1 }	/* (0..1,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
asn_TYPE_member_t asn_MBR_E_RABs_ToBeReleased_RelConfItem_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_E_RABs_ToBeReleased_RelConfItem_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_E_RABs_ToBeReleased_RelConfItem = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ .per_constraints = &asn_PER_type_E_RABs_ToBeReleased_RelConfItem_constr_1, .general_constraints = CHOICE_constraint },
