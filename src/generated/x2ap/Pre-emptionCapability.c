...
static int asn_validate_Pre_emptionCapability_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Pre_emptionCapability value = *(e_Pre_emptionCapability*)sptr;
    switch(value) {
    case Pre_emptionCapability_shall_not_trigger_pre_emption:
    case Pre_emptionCapability_may_trigger_pre_emption:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_Pre_emptionCapability = {
	...
	sizeof(asn_DEF_Pre_emptionCapability_tags_1)
		/sizeof(asn_DEF_Pre_emptionCapability_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_Pre_emptionCapability_constr_1, .general_constraints = asn_validate_Pre_emptionCapability_1 },
