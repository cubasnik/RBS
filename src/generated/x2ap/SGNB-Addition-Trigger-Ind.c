...
static int asn_validate_SGNB_Addition_Trigger_Ind_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SGNB_Addition_Trigger_Ind value = *(e_SGNB_Addition_Trigger_Ind*)sptr;
    switch(value) {
    case SGNB_Addition_Trigger_Ind_sn_change:
    case SGNB_Addition_Trigger_Ind_inter_eNB_HO:
    case SGNB_Addition_Trigger_Ind_intra_eNB_HO:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_SGNB_Addition_Trigger_Ind = {
	...
	sizeof(asn_DEF_SGNB_Addition_Trigger_Ind_tags_1)
		/sizeof(asn_DEF_SGNB_Addition_Trigger_Ind_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_SGNB_Addition_Trigger_Ind_constr_1, .general_constraints = asn_validate_SGNB_Addition_Trigger_Ind_1 },
