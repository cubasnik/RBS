...
extern asn_TYPE_descriptor_t asn_DEF_numberOfCellSpecificAntennaPorts __attribute__((weak, alias("asn_DEF_numberOfCellSpecificAntennaPorts_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_numberOfCellSpecificAntennaPorts_4;
static asn_TYPE_descriptor_t asn_DEF_numberOfCellSpecificAntennaPorts;
__attribute__((constructor)) static void asn_DEF_numberOfCellSpecificAntennaPorts_4_alias_init(void) {
	asn_DEF_numberOfCellSpecificAntennaPorts = asn_DEF_numberOfCellSpecificAntennaPorts_4;
}
#endif
...
static int asn_validate_numberOfCellSpecificAntennaPorts_4(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts value = *(e_RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts*)sptr;
    switch(value) {
    case RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts_one:
    case RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts_two:
    case RelativeNarrowbandTxPower__numberOfCellSpecificAntennaPorts_four:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_RelativeNarrowbandTxPower_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct RelativeNarrowbandTxPower, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P85,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
