...
asn_TYPE_member_t asn_MBR_TDD_InfoServedNRCell_Information_1[] = {
	{ ATF_POINTER, 0, offsetof(struct TDD_InfoServedNRCell_Information, nRFreqInfo),
	...
	{ ATF_POINTER, 0, offsetof(struct TDD_InfoServedNRCell_Information, nR_TxBW),
	...
	{ ATF_POINTER, 1, offsetof(struct TDD_InfoServedNRCell_Information, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P219,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
