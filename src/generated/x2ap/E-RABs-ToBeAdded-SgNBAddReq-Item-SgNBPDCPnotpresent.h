...
struct ProtocolExtensionContainer_162P171;
...
typedef struct E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPnotpresent {
	struct E_RAB_Level_QoS_Parameters	*requested_SCG_E_RAB_Level_QoS_Parameters;
	struct GTPtunnelEndpoint	*meNB_UL_GTP_TEIDatPDCP;
