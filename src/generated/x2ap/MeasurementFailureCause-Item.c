...
asn_TYPE_member_t asn_MBR_MeasurementFailureCause_Item_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct MeasurementFailureCause_Item, cause),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasurementFailureCause_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P136,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_MeasurementFailureCause_Item_specs_1 = {
