...
static int asn_validate_NSSS_NumOccasionDifferentPrecoder_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_NSSS_NumOccasionDifferentPrecoder value = *(e_NSSS_NumOccasionDifferentPrecoder*)sptr;
    switch(value) {
    case NSSS_NumOccasionDifferentPrecoder_two:
    case NSSS_NumOccasionDifferentPrecoder_four:
    case NSSS_NumOccasionDifferentPrecoder_eight:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_NSSS_NumOccasionDifferentPrecoder = {
	...
	sizeof(asn_DEF_NSSS_NumOccasionDifferentPrecoder_tags_1)
		/sizeof(asn_DEF_NSSS_NumOccasionDifferentPrecoder_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_NSSS_NumOccasionDifferentPrecoder_constr_1, .general_constraints = asn_validate_NSSS_NumOccasionDifferentPrecoder_1 },
