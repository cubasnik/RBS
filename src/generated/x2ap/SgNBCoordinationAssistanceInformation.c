...
static int asn_validate_SgNBCoordinationAssistanceInformation_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SgNBCoordinationAssistanceInformation value = *(e_SgNBCoordinationAssistanceInformation*)sptr;
    switch(value) {
    case SgNBCoordinationAssistanceInformation_coordination_not_required:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_SgNBCoordinationAssistanceInformation = {
	...
	sizeof(asn_DEF_SgNBCoordinationAssistanceInformation_tags_1)
		/sizeof(asn_DEF_SgNBCoordinationAssistanceInformation_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_SgNBCoordinationAssistanceInformation_constr_1, .general_constraints = asn_validate_SgNBCoordinationAssistanceInformation_1 },
