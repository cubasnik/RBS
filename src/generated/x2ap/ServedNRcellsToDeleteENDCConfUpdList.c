...
asn_per_constraints_t asn_PER_type_ServedNRcellsToDeleteENDCConfUpdList_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 14,  14,  1,  16384 }	/* (SIZE(1..16384)) */,
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
asn_TYPE_member_t asn_MBR_ServedNRcellsToDeleteENDCConfUpdList_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_ServedNRcellsToDeleteENDCConfUpdList_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ServedNRcellsToDeleteENDCConfUpdList = {
	...
	sizeof(asn_DEF_ServedNRcellsToDeleteENDCConfUpdList_tags_1)
		/sizeof(asn_DEF_ServedNRcellsToDeleteENDCConfUpdList_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ServedNRcellsToDeleteENDCConfUpdList_constr_1, .general_constraints = SEQUENCE_OF_constraint },
