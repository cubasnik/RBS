...
struct ProtocolExtensionContainer_162P138;
...
extern asn_SEQUENCE_specifics_t asn_SPC_CellMeasurementResult_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_CellMeasurementResult_Item_1[5];
