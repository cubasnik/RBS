...
asn_per_constraints_t asn_PER_type_PartialSuccessIndicator_constr_1 CC_NOTUSED = {
...
static int asn_validate_PartialSuccessIndicator_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PartialSuccessIndicator value = *(e_PartialSuccessIndicator*)sptr;
    switch(value) {
    case PartialSuccessIndicator_partial_success_allowed:
        return 0;
    }
    return -1;
}
...
const asn_INTEGER_specifics_t asn_SPC_PartialSuccessIndicator_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PartialSuccessIndicator = {
	...
	sizeof(asn_DEF_PartialSuccessIndicator_tags_1)
		/sizeof(asn_DEF_PartialSuccessIndicator_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_PartialSuccessIndicator_constr_1, .general_constraints = asn_validate_PartialSuccessIndicator_1 },
