...
asn_TYPE_member_t asn_MBR_MeasurementInitiationResult_Item_1[] = {
	{ ATF_POINTER, 0, offsetof(struct MeasurementInitiationResult_Item, cell_ID),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasurementInitiationResult_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P135,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_MeasurementInitiationResult_Item_specs_1 = {
