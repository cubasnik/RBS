...
asn_TYPE_member_t asn_MBR_ServedCellsToModify_Item_1[] = {
	{ ATF_POINTER, 0, offsetof(struct ServedCellsToModify_Item, old_ecgi),
	...
	{ ATF_POINTER, 0, offsetof(struct ServedCellsToModify_Item, servedCellInfo),
	...
	{ ATF_POINTER, 1, offsetof(struct ServedCellsToModify_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P133,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
