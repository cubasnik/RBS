...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_CSIReportPerCSIProcess__Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct CSIReportPerCSIProcess__Member, cSIProcessConfigurationIndex),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ .per_constraints = &asn_PER_memb_cSIProcessConfigurationIndex_constr_3, .general_constraints = memb_cSIProcessConfigurationIndex_constraint_2 },
	...
	{ ATF_POINTER, 1, offsetof(struct CSIReportPerCSIProcess__Member, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P27,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_TYPE_descriptor_t asn_DEF_Member_2 = {
	...
	asn_MBR_CSIReportPerCSIProcess__Member_2,
	3,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_CSIReportPerCSIProcess = {
	...
	sizeof(asn_DEF_CSIReportPerCSIProcess_tags_1)
		/sizeof(asn_DEF_CSIReportPerCSIProcess_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_CSIReportPerCSIProcess_constr_1, .general_constraints = SEQUENCE_OF_constraint },
