...
static int asn_validate_SCGChangeIndication_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SCGChangeIndication value = *(e_SCGChangeIndication*)sptr;
    switch(value) {
    case SCGChangeIndication_pDCPCountWrapAround:
    case SCGChangeIndication_pSCellChange:
    case SCGChangeIndication_other:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_SCGChangeIndication = {
	...
	sizeof(asn_DEF_SCGChangeIndication_tags_1)
		/sizeof(asn_DEF_SCGChangeIndication_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_SCGChangeIndication_constr_1, .general_constraints = asn_validate_SCGChangeIndication_1 },
