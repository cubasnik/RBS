...
static int asn_validate_CellDeploymentStatusIndicator_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_CellDeploymentStatusIndicator value = *(e_CellDeploymentStatusIndicator*)sptr;
    switch(value) {
    case CellDeploymentStatusIndicator_pre_change_notification:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_CellDeploymentStatusIndicator = {
	...
	sizeof(asn_DEF_CellDeploymentStatusIndicator_tags_1)
		/sizeof(asn_DEF_CellDeploymentStatusIndicator_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_CellDeploymentStatusIndicator_constr_1, .general_constraints = asn_validate_CellDeploymentStatusIndicator_1 },
