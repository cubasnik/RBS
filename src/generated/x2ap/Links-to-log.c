...
static int asn_validate_Links_to_log_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Links_to_log value = *(e_Links_to_log*)sptr;
    switch(value) {
    case Links_to_log_uplink:
    case Links_to_log_downlink:
    case Links_to_log_both_uplink_and_downlink:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_Links_to_log = {
	...
	sizeof(asn_DEF_Links_to_log_tags_1)
		/sizeof(asn_DEF_Links_to_log_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_Links_to_log_constr_1, .general_constraints = asn_validate_Links_to_log_1 },
