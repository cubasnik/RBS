...
asn_TYPE_member_t asn_MBR_UE_ContextInformationSeNBModReq_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct UE_ContextInformationSeNBModReq, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P148,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_UE_ContextInformationSeNBModReq_specs_1 = {
