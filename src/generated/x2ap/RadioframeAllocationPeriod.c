...
static int asn_validate_RadioframeAllocationPeriod_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RadioframeAllocationPeriod value = *(e_RadioframeAllocationPeriod*)sptr;
    switch(value) {
    case RadioframeAllocationPeriod_n1:
    case RadioframeAllocationPeriod_n2:
    case RadioframeAllocationPeriod_n4:
    case RadioframeAllocationPeriod_n8:
    case RadioframeAllocationPeriod_n16:
    case RadioframeAllocationPeriod_n32:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_RadioframeAllocationPeriod = {
	...
	sizeof(asn_DEF_RadioframeAllocationPeriod_tags_1)
		/sizeof(asn_DEF_RadioframeAllocationPeriod_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_RadioframeAllocationPeriod_constr_1, .general_constraints = asn_validate_RadioframeAllocationPeriod_1 },
