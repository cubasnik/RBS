...
static int asn_validate_M1ReportingTrigger_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_M1ReportingTrigger value = *(e_M1ReportingTrigger*)sptr;
    switch(value) {
    case M1ReportingTrigger_periodic:
    case M1ReportingTrigger_a2eventtriggered:
    case M1ReportingTrigger_a2eventtriggered_periodic:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_M1ReportingTrigger = {
	...
	sizeof(asn_DEF_M1ReportingTrigger_tags_1)
		/sizeof(asn_DEF_M1ReportingTrigger_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_M1ReportingTrigger_constr_1, .general_constraints = asn_validate_M1ReportingTrigger_1 },
