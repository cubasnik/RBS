...
static int asn_validate_MakeBeforeBreakIndicator_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_MakeBeforeBreakIndicator value = *(e_MakeBeforeBreakIndicator*)sptr;
    switch(value) {
    case MakeBeforeBreakIndicator_true:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_MakeBeforeBreakIndicator = {
	...
	sizeof(asn_DEF_MakeBeforeBreakIndicator_tags_1)
		/sizeof(asn_DEF_MakeBeforeBreakIndicator_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_MakeBeforeBreakIndicator_constr_1, .general_constraints = asn_validate_MakeBeforeBreakIndicator_1 },
