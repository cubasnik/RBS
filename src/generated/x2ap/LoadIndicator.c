...
static int asn_validate_LoadIndicator_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_LoadIndicator value = *(e_LoadIndicator*)sptr;
    switch(value) {
    case LoadIndicator_lowLoad:
    case LoadIndicator_mediumLoad:
    case LoadIndicator_highLoad:
    case LoadIndicator_overLoad:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_LoadIndicator = {
	...
	sizeof(asn_DEF_LoadIndicator_tags_1)
		/sizeof(asn_DEF_LoadIndicator_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_LoadIndicator_constr_1, .general_constraints = asn_validate_LoadIndicator_1 },
