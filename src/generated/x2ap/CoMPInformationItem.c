...
static asn_TYPE_member_t asn_MBR_CoMPInformationItem__Member_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CoMPInformationItem__Member, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P17,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_TYPE_descriptor_t asn_DEF_Member_2 = {
	...
	asn_MBR_CoMPInformationItem__Member_2,
	3,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_CoMPInformationItem = {
	...
	sizeof(asn_DEF_CoMPInformationItem_tags_1)
		/sizeof(asn_DEF_CoMPInformationItem_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_CoMPInformationItem_constr_1, .general_constraints = SEQUENCE_OF_constraint },
