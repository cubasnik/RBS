...
asn_TYPE_member_t asn_MBR_RNL_Header_1[] = {
	{ ATF_POINTER, 0, offsetof(struct RNL_Header, source_GlobalENB_ID),
	...
	{ ATF_POINTER, 1, offsetof(struct RNL_Header, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P141,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_RNL_Header_specs_1 = {
