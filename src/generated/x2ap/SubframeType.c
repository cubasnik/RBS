...
static int asn_validate_SubframeType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SubframeType value = *(e_SubframeType*)sptr;
    switch(value) {
    case SubframeType_mbsfn:
    case SubframeType_nonmbsfn:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_SubframeType = {
	...
	sizeof(asn_DEF_SubframeType_tags_1)
		/sizeof(asn_DEF_SubframeType_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_SubframeType_constr_1, .general_constraints = asn_validate_SubframeType_1 },
