...
asn_TYPE_member_t asn_MBR_CoMPInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct CoMPInformation, coMPInformationItem),
	...
	{ ATF_POINTER, 0, offsetof(struct CoMPInformation, coMPInformationStartTime),
	...
	{ ATF_POINTER, 1, offsetof(struct CoMPInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P16,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
