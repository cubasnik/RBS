...
extern asn_TYPE_descriptor_t asn_DEF_freqBandListNr __attribute__((weak, alias("asn_DEF_freqBandListNr_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_freqBandListNr_3;
static asn_TYPE_descriptor_t asn_DEF_freqBandListNr;
__attribute__((constructor)) static void asn_DEF_freqBandListNr_3_alias_init(void) {
	asn_DEF_freqBandListNr = asn_DEF_freqBandListNr_3;
}
#endif
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_NRFreqInfo__freqBandListNr_3[] = {
	{ ATF_POINTER, 0, 0,
...
asn_TYPE_descriptor_t asn_DEF_freqBandListNr_3 = {
	...
	{ .per_constraints = &asn_PER_type_freqBandListNr_constr_3, .general_constraints = SEQUENCE_OF_constraint },
	asn_MBR_NRFreqInfo__freqBandListNr_3,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_NRFreqInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NRFreqInfo, nRARFCN),
		...
		0,
		{ .per_constraints = &asn_PER_memb_nRARFCN_constr_2, .general_constraints = memb_nRARFCN_constraint_1 },
		0, 0, /* No default value */
		"nRARFCN"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NRFreqInfo, freqBandListNr),
		...
		0,
		{ .per_constraints = &asn_PER_memb_freqBandListNr_constr_3, .general_constraints = memb_freqBandListNr_constraint_1 },
		0, 0, /* No default value */
		"freqBandListNr"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct NRFreqInfo, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P72,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
