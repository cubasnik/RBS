...
static int asn_validate_SpecialSubframePatterns_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SpecialSubframePatterns value = *(e_SpecialSubframePatterns*)sptr;
    switch(value) {
    case SpecialSubframePatterns_ssp0:
    case SpecialSubframePatterns_ssp1:
    case SpecialSubframePatterns_ssp2:
    case SpecialSubframePatterns_ssp3:
    case SpecialSubframePatterns_ssp4:
    case SpecialSubframePatterns_ssp5:
    case SpecialSubframePatterns_ssp6:
    case SpecialSubframePatterns_ssp7:
    case SpecialSubframePatterns_ssp8:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_SpecialSubframePatterns = {
	...
	sizeof(asn_DEF_SpecialSubframePatterns_tags_1)
		/sizeof(asn_DEF_SpecialSubframePatterns_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_SpecialSubframePatterns_constr_1, .general_constraints = asn_validate_SpecialSubframePatterns_1 },
