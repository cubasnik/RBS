...
extern asn_TYPE_descriptor_t asn_DEF_nrModeInfo __attribute__((weak, alias("asn_DEF_nrModeInfo_7")));
#else
static asn_TYPE_descriptor_t asn_DEF_nrModeInfo_7;
static asn_TYPE_descriptor_t asn_DEF_nrModeInfo;
__attribute__((constructor)) static void asn_DEF_nrModeInfo_7_alias_init(void) {
	asn_DEF_nrModeInfo = asn_DEF_nrModeInfo_7;
}
#endif
...
static asn_TYPE_member_t asn_MBR_ServedNRCell_Information__nrModeInfo_7[] = {
...
asn_TYPE_member_t asn_MBR_ServedNRCell_Information_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct ServedNRCell_Information, nrCellID),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NRCGI,
		0,
	...
	{ ATF_POINTER, 0, offsetof(struct ServedNRCell_Information, broadcastPLMNs),
	...
	{ ATF_POINTER, 1, offsetof(struct ServedNRCell_Information, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P217,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
