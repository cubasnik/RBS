...
struct ProtocolExtensionContainer_162P190;
...
typedef struct E_RABs_Admitted_ToBeModified_SgNBModAck_Item {
	...
	struct E_RABs_Admitted_ToBeModified_SgNBModAck_Item__resource_configuration {
		...
		union E_RABs_Admitted_ToBeModified_SgNBModAck_Item__resource_configuration_u {
			...
			E_RABs_Admitted_ToBeModified_SgNBModAck_Item_SgNBPDCPnotpresent_t	 sgNBPDCPnotpresent;
			/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABs_Admitted_ToBeModified_SgNBModAck_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_E_RABs_Admitted_ToBeModified_SgNBModAck_Item_1[4];
