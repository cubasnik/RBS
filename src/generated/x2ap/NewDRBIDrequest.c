...
static int asn_validate_NewDRBIDrequest_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_NewDRBIDrequest value = *(e_NewDRBIDrequest*)sptr;
    switch(value) {
    case NewDRBIDrequest_true:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_NewDRBIDrequest = {
	...
	sizeof(asn_DEF_NewDRBIDrequest_tags_1)
		/sizeof(asn_DEF_NewDRBIDrequest_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_NewDRBIDrequest_constr_1, .general_constraints = asn_validate_NewDRBIDrequest_1 },
