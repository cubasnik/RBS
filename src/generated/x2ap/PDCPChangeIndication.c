...
static int asn_validate_PDCPChangeIndication_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PDCPChangeIndication value = *(e_PDCPChangeIndication*)sptr;
    switch(value) {
    case PDCPChangeIndication_s_KgNB_update_required:
    case PDCPChangeIndication_pDCP_data_recovery_required:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_PDCPChangeIndication = {
	...
	sizeof(asn_DEF_PDCPChangeIndication_tags_1)
		/sizeof(asn_DEF_PDCPChangeIndication_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_PDCPChangeIndication_constr_1, .general_constraints = asn_validate_PDCPChangeIndication_1 },
