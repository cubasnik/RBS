...
asn_TYPE_member_t asn_MBR_WidebandCQI_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct WidebandCQI, widebandCQICodeword0),
		...
		0,
		{ .per_constraints = &asn_PER_memb_widebandCQICodeword0_constr_2, .general_constraints = memb_widebandCQICodeword0_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct WidebandCQI, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P123,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
