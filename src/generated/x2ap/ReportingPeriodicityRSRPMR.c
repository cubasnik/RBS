...
static int asn_validate_ReportingPeriodicityRSRPMR_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ReportingPeriodicityRSRPMR value = *(e_ReportingPeriodicityRSRPMR*)sptr;
    switch(value) {
    case ReportingPeriodicityRSRPMR_one_hundred_20_ms:
    case ReportingPeriodicityRSRPMR_two_hundred_40_ms:
    case ReportingPeriodicityRSRPMR_four_hundred_80_ms:
    case ReportingPeriodicityRSRPMR_six_hundred_40_ms:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ReportingPeriodicityRSRPMR = {
	...
	sizeof(asn_DEF_ReportingPeriodicityRSRPMR_tags_1)
		/sizeof(asn_DEF_ReportingPeriodicityRSRPMR_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ReportingPeriodicityRSRPMR_constr_1, .general_constraints = asn_validate_ReportingPeriodicityRSRPMR_1 },
