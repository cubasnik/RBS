...
static int asn_validate_numberOfCellSpecificAntennaPorts_3(const asn_TYPE_descriptor_t *td,
                       ...
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ABSInformationFDD__numberOfCellSpecificAntennaPorts value = *(e_ABSInformationFDD__numberOfCellSpecificAntennaPorts*)sptr;
    switch(value) {
    case ABSInformationFDD__numberOfCellSpecificAntennaPorts_one:
    case ABSInformationFDD__numberOfCellSpecificAntennaPorts_two:
    case ABSInformationFDD__numberOfCellSpecificAntennaPorts_four:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_ABSInformationFDD_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ABSInformationFDD, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P0,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
