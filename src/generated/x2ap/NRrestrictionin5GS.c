...
static int asn_validate_NRrestrictionin5GS_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_NRrestrictionin5GS value = *(e_NRrestrictionin5GS*)sptr;
    switch(value) {
    case NRrestrictionin5GS_nRrestrictedin5GS:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_NRrestrictionin5GS = {
	...
	sizeof(asn_DEF_NRrestrictionin5GS_tags_1)
		/sizeof(asn_DEF_NRrestrictionin5GS_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_NRrestrictionin5GS_constr_1, .general_constraints = asn_validate_NRrestrictionin5GS_1 },
