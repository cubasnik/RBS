...
asn_TYPE_member_t asn_MBR_ExtendedULInterferenceOverloadInfo_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ExtendedULInterferenceOverloadInfo, associatedSubframes),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ .per_constraints = &asn_PER_memb_associatedSubframes_constr_2, .general_constraints = memb_associatedSubframes_constraint_1 },
		0, 0, /* No default value */
		"associatedSubframes"
		},
	{ ATF_POINTER, 0, offsetof(struct ExtendedULInterferenceOverloadInfo, extended_ul_InterferenceOverloadIndication),
	...
	{ ATF_POINTER, 1, offsetof(struct ExtendedULInterferenceOverloadInfo, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P42,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
