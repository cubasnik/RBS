...
struct ProtocolExtensionContainer_162P197;
...
typedef struct E_RABs_ToBeModified_SgNBModReqd_Item {
	...
	struct E_RABs_ToBeModified_SgNBModReqd_Item__resource_configuration {
		...
		union E_RABs_ToBeModified_SgNBModReqd_Item__resource_configuration_u {
			...
			E_RABs_ToBeModified_SgNBModReqd_Item_SgNBPDCPnotpresent_t	 sgNBPDCPnotpresent;
			/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABs_ToBeModified_SgNBModReqd_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_E_RABs_ToBeModified_SgNBModReqd_Item_1[4];
