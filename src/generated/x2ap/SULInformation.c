...
asn_TYPE_member_t asn_MBR_SULInformation_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SULInformation, sUL_ARFCN),
		...
		0,
		{ .per_constraints = &asn_PER_memb_sUL_ARFCN_constr_2, .general_constraints = memb_sUL_ARFCN_constraint_1 },
		0, 0, /* No default value */
		"sUL-ARFCN"
		},
	{ ATF_POINTER, 0, offsetof(struct SULInformation, sUL_TxBW),
	...
	{ ATF_POINTER, 1, offsetof(struct SULInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P100,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
