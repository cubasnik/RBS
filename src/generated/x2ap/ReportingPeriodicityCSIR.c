...
static int asn_validate_ReportingPeriodicityCSIR_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ReportingPeriodicityCSIR value = *(e_ReportingPeriodicityCSIR*)sptr;
    switch(value) {
    case ReportingPeriodicityCSIR_ms5:
    case ReportingPeriodicityCSIR_ms10:
    case ReportingPeriodicityCSIR_ms20:
    case ReportingPeriodicityCSIR_ms40:
    case ReportingPeriodicityCSIR_ms80:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ReportingPeriodicityCSIR = {
	...
	sizeof(asn_DEF_ReportingPeriodicityCSIR_tags_1)
		/sizeof(asn_DEF_ReportingPeriodicityCSIR_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ReportingPeriodicityCSIR_constr_1, .general_constraints = asn_validate_ReportingPeriodicityCSIR_1 },
