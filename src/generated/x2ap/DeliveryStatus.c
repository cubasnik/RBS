...
asn_TYPE_member_t asn_MBR_DeliveryStatus_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct DeliveryStatus, highestSuccessDeliveredPDCPSN),
		...
		0,
		{ .per_constraints = &asn_PER_memb_highestSuccessDeliveredPDCPSN_constr_2, .general_constraints = memb_highestSuccessDeliveredPDCPSN_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct DeliveryStatus, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P30,
		0,
		{
