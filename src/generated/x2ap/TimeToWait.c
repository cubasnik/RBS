...
static int asn_validate_TimeToWait_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_TimeToWait value = *(e_TimeToWait*)sptr;
    switch(value) {
    case TimeToWait_v1s:
    case TimeToWait_v2s:
    case TimeToWait_v5s:
    case TimeToWait_v10s:
    case TimeToWait_v20s:
    case TimeToWait_v60s:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_TimeToWait = {
	...
	sizeof(asn_DEF_TimeToWait_tags_1)
		/sizeof(asn_DEF_TimeToWait_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_TimeToWait_constr_1, .general_constraints = asn_validate_TimeToWait_1 },
