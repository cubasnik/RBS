...
#define ProtocolIE_ID_id_NRUeReport	((ProtocolIE_ID_t)243)
...
#define ProtocolIE_ID_id_endcSONConfigurationTransfer	((ProtocolIE_ID_t)326)
#define ProtocolIE_ID_id_NRNeighbourInfoToAdd	((ProtocolIE_ID_t)327)
#define ProtocolIE_ID_id_NRNeighbourInfoToModify	((ProtocolIE_ID_t)328)
#define ProtocolIE_ID_id_DesiredActNotificationLevel	((ProtocolIE_ID_t)329)
#define ProtocolIE_ID_id_LocationInformationSgNBReporting	((ProtocolIE_ID_t)330)
#define ProtocolIE_ID_id_LocationInformationSgNB	((ProtocolIE_ID_t)331)
#define ProtocolIE_ID_id_LastNG_RANPLMNIdentity	((ProtocolIE_ID_t)332)
#define ProtocolIE_ID_id_EUTRANTraceID	((ProtocolIE_ID_t)333)
#define ProtocolIE_ID_id_additionalPLMNs_Item	((ProtocolIE_ID_t)334)
#define ProtocolIE_ID_id_InterfaceInstanceIndication	((ProtocolIE_ID_t)335)
#define ProtocolIE_ID_id_BPLMN_ID_Info_EUTRA	((ProtocolIE_ID_t)336)
#define ProtocolIE_ID_id_BPLMN_ID_Info_NR	((ProtocolIE_ID_t)337)
#define ProtocolIE_ID_id_NBIoT_UL_DL_AlignmentOffset	((ProtocolIE_ID_t)338)
#define ProtocolIE_ID_id_ERABs_transferred_to_MeNB	((ProtocolIE_ID_t)339)
#define ProtocolIE_ID_id_EPCHandoverRestrictionListContainer	((ProtocolIE_ID_t)360)
