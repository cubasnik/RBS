...
static int asn_validate_CyclicPrefixDL_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_CyclicPrefixDL value = *(e_CyclicPrefixDL*)sptr;
    switch(value) {
    case CyclicPrefixDL_normal:
    case CyclicPrefixDL_extended:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_CyclicPrefixDL = {
	...
	sizeof(asn_DEF_CyclicPrefixDL_tags_1)
		/sizeof(asn_DEF_CyclicPrefixDL_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_CyclicPrefixDL_constr_1, .general_constraints = asn_validate_CyclicPrefixDL_1 },
