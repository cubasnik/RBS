...
extern asn_TYPE_descriptor_t asn_DEF_pA_list __attribute__((weak, alias("asn_DEF_pA_list_4")));
#else
static asn_TYPE_descriptor_t asn_DEF_pA_list_4;
static asn_TYPE_descriptor_t asn_DEF_pA_list;
__attribute__((constructor)) static void asn_DEF_pA_list_4_alias_init(void) {
	asn_DEF_pA_list = asn_DEF_pA_list_4;
}
#endif
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_DynamicNAICSInformation__pA_list_4[] = {
	{ ATF_POINTER, 0, 0,
...
asn_TYPE_descriptor_t asn_DEF_pA_list_4 = {
	...
	{ .per_constraints = &asn_PER_type_pA_list_constr_4, .general_constraints = SEQUENCE_OF_constraint },
	asn_MBR_DynamicNAICSInformation__pA_list_4,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_DynamicNAICSInformation_1[] = {
	{ ATF_POINTER, 2, offsetof(struct DynamicNAICSInformation, transmissionModes),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ .per_constraints = &asn_PER_memb_transmissionModes_constr_2, .general_constraints = memb_transmissionModes_constraint_1 },
		0, 0, /* No default value */
		"transmissionModes"
		},
	{ ATF_POINTER, 1, offsetof(struct DynamicNAICSInformation, pB_information),
		...
		0,
		{ .per_constraints = &asn_PER_memb_pB_information_constr_3, .general_constraints = memb_pB_information_constraint_1 },
		0, 0, /* No default value */
		"pB-information"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct DynamicNAICSInformation, pA_list),
		...
		&asn_DEF_pA_list_4,
		0,
		{ .per_constraints = &asn_PER_memb_pA_list_constr_4, .general_constraints = memb_pA_list_constraint_1 },
		0, 0, /* No default value */
		"pA-list"
		},
	{ ATF_POINTER, 1, offsetof(struct DynamicNAICSInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P31,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
