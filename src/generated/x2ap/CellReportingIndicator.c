...
static int asn_validate_CellReportingIndicator_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_CellReportingIndicator value = *(e_CellReportingIndicator*)sptr;
    switch(value) {
    case CellReportingIndicator_stop_request:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_CellReportingIndicator = {
	...
	sizeof(asn_DEF_CellReportingIndicator_tags_1)
		/sizeof(asn_DEF_CellReportingIndicator_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_CellReportingIndicator_constr_1, .general_constraints = asn_validate_CellReportingIndicator_1 },
