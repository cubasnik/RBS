...
static int asn_validate_BandwidthReducedSI_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_BandwidthReducedSI value = *(e_BandwidthReducedSI*)sptr;
    switch(value) {
    case BandwidthReducedSI_scheduled:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_BandwidthReducedSI = {
	...
	sizeof(asn_DEF_BandwidthReducedSI_tags_1)
		/sizeof(asn_DEF_BandwidthReducedSI_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_BandwidthReducedSI_constr_1, .general_constraints = asn_validate_BandwidthReducedSI_1 },
