...
asn_TYPE_member_t asn_MBR_FDD_InfoNeighbourServedNRCell_Information_1[] = {
	{ ATF_POINTER, 0, offsetof(struct FDD_InfoNeighbourServedNRCell_Information, ul_NRFreqInfo),
	...
	{ ATF_POINTER, 0, offsetof(struct FDD_InfoNeighbourServedNRCell_Information, dl_NRFreqInfo),
	...
	{ ATF_POINTER, 1, offsetof(struct FDD_InfoNeighbourServedNRCell_Information, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P44,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
