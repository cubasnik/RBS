...
static int asn_validate_PDCPSnLength_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_PDCPSnLength value = *(e_PDCPSnLength*)sptr;
    switch(value) {
    case PDCPSnLength_twelve_bits:
    case PDCPSnLength_eighteen_bits:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_PDCPSnLength = {
	...
	sizeof(asn_DEF_PDCPSnLength_tags_1)
		/sizeof(asn_DEF_PDCPSnLength_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_PDCPSnLength_constr_1, .general_constraints = asn_validate_PDCPSnLength_1 },
