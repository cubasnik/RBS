...
asn_per_constraints_t asn_PER_type_ListofEUTRACellsinEUTRACoordinationReq_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 9,  9,  0,  256 }	/* (SIZE(0..256)) */,
	0, 0	/* No PER value map */
};
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
asn_TYPE_member_t asn_MBR_ListofEUTRACellsinEUTRACoordinationReq_1[] = {
	{ ATF_POINTER, 0, 0,
...
asn_SET_OF_specifics_t asn_SPC_ListofEUTRACellsinEUTRACoordinationReq_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_ListofEUTRACellsinEUTRACoordinationReq = {
	...
	sizeof(asn_DEF_ListofEUTRACellsinEUTRACoordinationReq_tags_1)
		/sizeof(asn_DEF_ListofEUTRACellsinEUTRACoordinationReq_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ListofEUTRACellsinEUTRACoordinationReq_constr_1, .general_constraints = SEQUENCE_OF_constraint },
