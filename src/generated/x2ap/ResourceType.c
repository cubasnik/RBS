...
static int asn_validate_ResourceType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ResourceType value = *(e_ResourceType*)sptr;
    switch(value) {
    case ResourceType_downlinknonCRS:
    case ResourceType_cRS:
    case ResourceType_uplink:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ResourceType = {
	...
	sizeof(asn_DEF_ResourceType_tags_1)
		/sizeof(asn_DEF_ResourceType_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ResourceType_constr_1, .general_constraints = asn_validate_ResourceType_1 },
