...
static int asn_validate_Reestablishment_Indication_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Reestablishment_Indication value = *(e_Reestablishment_Indication*)sptr;
    switch(value) {
    case Reestablishment_Indication_reestablished:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_Reestablishment_Indication = {
	...
	sizeof(asn_DEF_Reestablishment_Indication_tags_1)
		/sizeof(asn_DEF_Reestablishment_Indication_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_Reestablishment_Indication_constr_1, .general_constraints = asn_validate_Reestablishment_Indication_1 },
