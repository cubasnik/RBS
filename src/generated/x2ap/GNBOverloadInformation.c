...
static int asn_validate_GNBOverloadInformation_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_GNBOverloadInformation value = *(e_GNBOverloadInformation*)sptr;
    switch(value) {
    case GNBOverloadInformation_overloaded:
    case GNBOverloadInformation_not_overloaded:
        return 0;
    }
    return -1;
}
