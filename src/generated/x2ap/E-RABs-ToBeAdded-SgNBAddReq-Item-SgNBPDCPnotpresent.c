...
asn_TYPE_member_t asn_MBR_E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPnotpresent_1[] = {
	{ ATF_POINTER, 0, offsetof(struct E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPnotpresent, requested_SCG_E_RAB_Level_QoS_Parameters),
	...
	{ ATF_POINTER, 0, offsetof(struct E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPnotpresent, meNB_UL_GTP_TEIDatPDCP),
	...
	{ ATF_POINTER, 1, offsetof(struct E_RABs_ToBeAdded_SgNBAddReq_Item_SgNBPDCPnotpresent, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P171,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
