...
static int asn_validate_RRC_Config_Ind_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RRC_Config_Ind value = *(e_RRC_Config_Ind*)sptr;
    switch(value) {
    case RRC_Config_Ind_full_config:
    case RRC_Config_Ind_delta_config:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_RRC_Config_Ind = {
	...
	sizeof(asn_DEF_RRC_Config_Ind_tags_1)
		/sizeof(asn_DEF_RRC_Config_Ind_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_RRC_Config_Ind_constr_1, .general_constraints = asn_validate_RRC_Config_Ind_1 },
