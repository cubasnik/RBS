...
static int asn_validate_ProSeDirectDiscovery_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ProSeDirectDiscovery value = *(e_ProSeDirectDiscovery*)sptr;
    switch(value) {
    case ProSeDirectDiscovery_authorized:
    case ProSeDirectDiscovery_not_authorized:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_ProSeDirectDiscovery = {
	...
	sizeof(asn_DEF_ProSeDirectDiscovery_tags_1)
		/sizeof(asn_DEF_ProSeDirectDiscovery_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_ProSeDirectDiscovery_constr_1, .general_constraints = asn_validate_ProSeDirectDiscovery_1 },
