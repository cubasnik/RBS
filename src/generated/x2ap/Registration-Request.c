...
static int asn_validate_Registration_Request_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_Registration_Request value = *(e_Registration_Request*)sptr;
    switch(value) {
    case Registration_Request_start:
    case Registration_Request_stop:
    case Registration_Request_partial_stop:
    case Registration_Request_add:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_Registration_Request = {
	...
	sizeof(asn_DEF_Registration_Request_tags_1)
		/sizeof(asn_DEF_Registration_Request_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_Registration_Request_constr_1, .general_constraints = asn_validate_Registration_Request_1 },
