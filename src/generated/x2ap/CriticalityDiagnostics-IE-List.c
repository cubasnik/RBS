...
static asn_TYPE_member_t asn_MBR_CriticalityDiagnostics_IE_List__Member_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct CriticalityDiagnostics_IE_List__Member, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P25,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_TYPE_descriptor_t asn_DEF_Member_2 = {
	...
	asn_MBR_CriticalityDiagnostics_IE_List__Member_2,
	4,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_CriticalityDiagnostics_IE_List = {
	...
	sizeof(asn_DEF_CriticalityDiagnostics_IE_List_tags_1)
		/sizeof(asn_DEF_CriticalityDiagnostics_IE_List_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_CriticalityDiagnostics_IE_List_constr_1, .general_constraints = SEQUENCE_OF_constraint },
