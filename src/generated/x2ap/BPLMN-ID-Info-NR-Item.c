...
asn_TYPE_member_t asn_MBR_BPLMN_ID_Info_NR_Item_1[] = {
	{ ATF_POINTER, 0, offsetof(struct BPLMN_ID_Info_NR_Item, broadcastPLMNs),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BroadcastextPLMNs,
		0,
		{
	...
	{ ATF_POINTER, 1, offsetof(struct BPLMN_ID_Info_NR_Item, fiveGStac),
	...
	{ ATF_POINTER, 1, offsetof(struct BPLMN_ID_Info_NR_Item, iE_Extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P9,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
static const int asn_MAP_BPLMN_ID_Info_NR_Item_oms_1[] = { 1, 3 };
