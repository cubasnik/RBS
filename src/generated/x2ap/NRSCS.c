...
static int asn_validate_NRSCS_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_NRSCS value = *(e_NRSCS*)sptr;
    switch(value) {
    case NRSCS_scs15:
    case NRSCS_scs30:
    case NRSCS_scs60:
...
asn_TYPE_descriptor_t asn_DEF_NRSCS = {
	...
	sizeof(asn_DEF_NRSCS_tags_1)
		/sizeof(asn_DEF_NRSCS_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_NRSCS_constr_1, .general_constraints = asn_validate_NRSCS_1 },
