...
extern asn_TYPE_descriptor_t asn_DEF_numberOfCellSpecificAntennaPorts __attribute__((weak, alias("asn_DEF_numberOfCellSpecificAntennaPorts_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_numberOfCellSpecificAntennaPorts_3;
static asn_TYPE_descriptor_t asn_DEF_numberOfCellSpecificAntennaPorts;
__attribute__((constructor)) static void asn_DEF_numberOfCellSpecificAntennaPorts_3_alias_init(void) {
	asn_DEF_numberOfCellSpecificAntennaPorts = asn_DEF_numberOfCellSpecificAntennaPorts_3;
}
#endif
...
static int asn_validate_numberOfCellSpecificAntennaPorts_3(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_ABSInformationTDD__numberOfCellSpecificAntennaPorts value = *(e_ABSInformationTDD__numberOfCellSpecificAntennaPorts*)sptr;
    switch(value) {
    case ABSInformationTDD__numberOfCellSpecificAntennaPorts_one:
    case ABSInformationTDD__numberOfCellSpecificAntennaPorts_two:
    case ABSInformationTDD__numberOfCellSpecificAntennaPorts_four:
        return 0;
    }
    return -1;
}
...
asn_TYPE_member_t asn_MBR_ABSInformationTDD_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ABSInformationTDD, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P1,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
