...
static int asn_validate_AerialUEsubscriptionInformation_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_AerialUEsubscriptionInformation value = *(e_AerialUEsubscriptionInformation*)sptr;
    switch(value) {
    case AerialUEsubscriptionInformation_allowed:
    case AerialUEsubscriptionInformation_not_allowed:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_AerialUEsubscriptionInformation = {
	...
	sizeof(asn_DEF_AerialUEsubscriptionInformation_tags_1)
		/sizeof(asn_DEF_AerialUEsubscriptionInformation_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_AerialUEsubscriptionInformation_constr_1, .general_constraints = asn_validate_AerialUEsubscriptionInformation_1 },
