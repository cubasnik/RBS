...
static int asn_validate_HandoverReportType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_HandoverReportType value = *(e_HandoverReportType*)sptr;
    switch(value) {
    case HandoverReportType_hoTooEarly:
    case HandoverReportType_hoToWrongCell:
    case HandoverReportType_interRATpingpong:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_HandoverReportType = {
	...
	sizeof(asn_DEF_HandoverReportType_tags_1)
		/sizeof(asn_DEF_HandoverReportType_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_HandoverReportType_constr_1, .general_constraints = asn_validate_HandoverReportType_1 },
