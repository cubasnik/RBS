...
static int asn_validate_NRS_NSSS_PowerOffset_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_NRS_NSSS_PowerOffset value = *(e_NRS_NSSS_PowerOffset*)sptr;
    switch(value) {
    case NRS_NSSS_PowerOffset_minusThree:
    case NRS_NSSS_PowerOffset_zero:
    case NRS_NSSS_PowerOffset_three:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_NRS_NSSS_PowerOffset = {
	...
	sizeof(asn_DEF_NRS_NSSS_PowerOffset_tags_1)
		/sizeof(asn_DEF_NRS_NSSS_PowerOffset_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_NRS_NSSS_PowerOffset_constr_1, .general_constraints = asn_validate_NRS_NSSS_PowerOffset_1 },
