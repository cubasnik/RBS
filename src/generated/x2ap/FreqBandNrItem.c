...
extern asn_TYPE_descriptor_t asn_DEF_supportedSULBandList __attribute__((weak, alias("asn_DEF_supportedSULBandList_3")));
#else
static asn_TYPE_descriptor_t asn_DEF_supportedSULBandList_3;
static asn_TYPE_descriptor_t asn_DEF_supportedSULBandList;
__attribute__((constructor)) static void asn_DEF_supportedSULBandList_3_alias_init(void) {
	asn_DEF_supportedSULBandList = asn_DEF_supportedSULBandList_3;
}
#endif
...
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
static asn_TYPE_member_t asn_MBR_FreqBandNrItem__supportedSULBandList_3[] = {
	{ ATF_POINTER, 0, 0,
...
asn_TYPE_member_t asn_MBR_FreqBandNrItem_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct FreqBandNrItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P47,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
