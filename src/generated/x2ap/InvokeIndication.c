...
static int asn_validate_InvokeIndication_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_InvokeIndication value = *(e_InvokeIndication*)sptr;
    switch(value) {
    case InvokeIndication_abs_information:
    case InvokeIndication_naics_information_start:
    case InvokeIndication_naics_information_stop:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_InvokeIndication = {
	...
	sizeof(asn_DEF_InvokeIndication_tags_1)
		/sizeof(asn_DEF_InvokeIndication_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_InvokeIndication_constr_1, .general_constraints = asn_validate_InvokeIndication_1 },
