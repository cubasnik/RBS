...
static int asn_validate_SRBType_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_SRBType value = *(e_SRBType*)sptr;
    switch(value) {
    case SRBType_srb1:
    case SRBType_srb2:
        return 0;
...
asn_TYPE_descriptor_t asn_DEF_SRBType = {
	...
	sizeof(asn_DEF_SRBType_tags_1)
		/sizeof(asn_DEF_SRBType_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_SRBType_constr_1, .general_constraints = asn_validate_SRBType_1 },
