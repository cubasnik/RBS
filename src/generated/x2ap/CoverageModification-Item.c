...
asn_TYPE_member_t asn_MBR_CoverageModification_Item_1[] = {
	{ ATF_POINTER, 0, offsetof(struct CoverageModification_Item, eCGI),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct CoverageModification_Item, coverageState),
		...
		0,
		{ .per_constraints = &asn_PER_memb_coverageState_constr_3, .general_constraints = memb_coverageState_constraint_1 },
		0, 0, /* No default value */
		"coverageState"
		},
