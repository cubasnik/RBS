...
static int asn_validate_RLCMode_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_RLCMode value = *(e_RLCMode*)sptr;
    switch(value) {
    case RLCMode_rlc_am:
    case RLCMode_rlc_um_bidirectional:
    case RLCMode_rlc_um_unidirectional_ul:
    case RLCMode_rlc_um_unidirectional_dl:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_RLCMode = {
	...
	sizeof(asn_DEF_RLCMode_tags_1)
		/sizeof(asn_DEF_RLCMode_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_RLCMode_constr_1, .general_constraints = asn_validate_RLCMode_1 },
