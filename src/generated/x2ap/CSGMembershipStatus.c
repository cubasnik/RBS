...
static int asn_validate_CSGMembershipStatus_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_CSGMembershipStatus value = *(e_CSGMembershipStatus*)sptr;
    switch(value) {
    case CSGMembershipStatus_member:
    case CSGMembershipStatus_not_member:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_CSGMembershipStatus = {
	...
	sizeof(asn_DEF_CSGMembershipStatus_tags_1)
		/sizeof(asn_DEF_CSGMembershipStatus_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_CSGMembershipStatus_constr_1, .general_constraints = asn_validate_CSGMembershipStatus_1 },
