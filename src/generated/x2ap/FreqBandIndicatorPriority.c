...
static int asn_validate_FreqBandIndicatorPriority_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_FreqBandIndicatorPriority value = *(e_FreqBandIndicatorPriority*)sptr;
    switch(value) {
    case FreqBandIndicatorPriority_not_broadcasted:
    case FreqBandIndicatorPriority_broadcasted:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_FreqBandIndicatorPriority = {
	...
	sizeof(asn_DEF_FreqBandIndicatorPriority_tags_1)
		/sizeof(asn_DEF_FreqBandIndicatorPriority_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_FreqBandIndicatorPriority_constr_1, .general_constraints = asn_validate_FreqBandIndicatorPriority_1 },
