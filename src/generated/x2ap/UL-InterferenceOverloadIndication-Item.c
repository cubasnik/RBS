...
static int asn_validate_UL_InterferenceOverloadIndication_Item_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_UL_InterferenceOverloadIndication_Item value = *(e_UL_InterferenceOverloadIndication_Item*)sptr;
    switch(value) {
    case UL_InterferenceOverloadIndication_Item_high_interference:
    case UL_InterferenceOverloadIndication_Item_medium_interference:
    case UL_InterferenceOverloadIndication_Item_low_interference:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_UL_InterferenceOverloadIndication_Item = {
	...
	sizeof(asn_DEF_UL_InterferenceOverloadIndication_Item_tags_1)
		/sizeof(asn_DEF_UL_InterferenceOverloadIndication_Item_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_UL_InterferenceOverloadIndication_Item_constr_1, .general_constraints = asn_validate_UL_InterferenceOverloadIndication_Item_1 },
