...
static int asn_validate_M4period_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_M4period value = *(e_M4period*)sptr;
    switch(value) {
    case M4period_ms1024:
    case M4period_ms2048:
    case M4period_ms5120:
    case M4period_ms10240:
    case M4period_min1:
        return 0;
    }
    return -1;
...
asn_TYPE_descriptor_t asn_DEF_M4period = {
	...
	sizeof(asn_DEF_M4period_tags_1)
		/sizeof(asn_DEF_M4period_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_M4period_constr_1, .general_constraints = asn_validate_M4period_1 },
