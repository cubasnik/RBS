...
asn_TYPE_member_t asn_MBR_CompositeAvailableCapacityGroup_1[] = {
	{ ATF_POINTER, 0, offsetof(struct CompositeAvailableCapacityGroup, dL_CompositeAvailableCapacity),
	...
	{ ATF_POINTER, 0, offsetof(struct CompositeAvailableCapacityGroup, uL_CompositeAvailableCapacity),
	...
	{ ATF_POINTER, 1, offsetof(struct CompositeAvailableCapacityGroup, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P20,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
