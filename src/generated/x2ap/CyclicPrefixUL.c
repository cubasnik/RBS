...
static int asn_validate_CyclicPrefixUL_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_CyclicPrefixUL value = *(e_CyclicPrefixUL*)sptr;
    switch(value) {
    case CyclicPrefixUL_normal:
    case CyclicPrefixUL_extended:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_CyclicPrefixUL = {
	...
	sizeof(asn_DEF_CyclicPrefixUL_tags_1)
		/sizeof(asn_DEF_CyclicPrefixUL_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_CyclicPrefixUL_constr_1, .general_constraints = asn_validate_CyclicPrefixUL_1 },
