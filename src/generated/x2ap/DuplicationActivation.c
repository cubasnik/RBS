...
static int asn_validate_DuplicationActivation_1(const asn_TYPE_descriptor_t *td,
                       const void *sptr,
                       asn_app_constraint_failed_f *ctfailcb,
                       void* app_key) {
    if(! sptr) { return -1; }
    e_DuplicationActivation value = *(e_DuplicationActivation*)sptr;
    switch(value) {
    case DuplicationActivation_active:
    case DuplicationActivation_inactive:
        return 0;
    }
    return -1;
}
...
asn_TYPE_descriptor_t asn_DEF_DuplicationActivation = {
	...
	sizeof(asn_DEF_DuplicationActivation_tags_1)
		/sizeof(asn_DEF_DuplicationActivation_tags_1[0]), /* 1 */
	{ .per_constraints = &asn_PER_type_DuplicationActivation_constr_1, .general_constraints = asn_validate_DuplicationActivation_1 },
