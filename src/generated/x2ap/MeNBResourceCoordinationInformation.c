...
asn_TYPE_member_t asn_MBR_MeNBResourceCoordinationInformation_1[] = {
	{ ATF_POINTER, 0, offsetof(struct MeNBResourceCoordinationInformation, eUTRA_Cell_ID),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct MeNBResourceCoordinationInformation, uLCoordinationInformation),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ .per_constraints = &asn_PER_memb_uLCoordinationInformation_constr_3, .general_constraints = memb_uLCoordinationInformation_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 2, offsetof(struct MeNBResourceCoordinationInformation, dLCoordinationInformation),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ .per_constraints = &asn_PER_memb_dLCoordinationInformation_constr_4, .general_constraints = memb_dLCoordinationInformation_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct MeNBResourceCoordinationInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P67,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
