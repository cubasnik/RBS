...
asn_TYPE_member_t asn_MBR_E_RABs_ToBeReleased_SgNBModReqd_Item_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct E_RABs_ToBeReleased_SgNBModReqd_Item, cause),
	...
	{ ATF_POINTER, 1, offsetof(struct E_RABs_ToBeReleased_SgNBModReqd_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_162P196,
		0,
		{
#if !defined(ASN_DISABLE_OER_SUPPORT)
			0,
...
asn_SEQUENCE_specifics_t asn_SPC_E_RABs_ToBeReleased_SgNBModReqd_Item_specs_1 = {
