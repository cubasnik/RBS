...
#define ProcedureCode_id_deactivateTrace	((ProcedureCode_t)46)
#define ProcedureCode_id_traceStart	((ProcedureCode_t)47)
#define ProcedureCode_id_endcConfigurationTransfer	((ProcedureCode_t)48)
